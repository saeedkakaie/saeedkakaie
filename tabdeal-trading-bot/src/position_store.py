...
class PositionStore:
    ...
    بدون این: هر بار پردازش دوباره اجرا شود، self.positions خالی می‌شود؛
    یعنی هم حد ضرر/سود پوزیشن‌های واقعاً باز دیگر چک نمی‌شود، هم موجودی
    آزادی که واقعا صرف آن‌ها شده فراموش می‌شود و ممکن است دوباره روی همان
    دارایی سرمایه تخصیص داده شود.
    """
